...
export default function Sidebar({
  ...
  return (
    <div className="z-50 fixed top-2 right-4 flex items-center">
      ...
      <div
        className="relative ml-4 w-10 h-10 flex justify-center items-center animate-pulse"
        id="mute-box"
      >
        <img
          className="absolute w-full h-full"
          src="./sidebar/bg-mute-button.png"
          alt=""
        />
        <button
