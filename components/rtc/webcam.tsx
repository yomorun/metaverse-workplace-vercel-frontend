...
import { trackMapState } from '../../store/atom'

import { getRtcToken } from '../../libs/request'

import type { TrackMapValue } from '../../types'
...
const Webcam = ({ cover, name, channel }: Props) => {
    ...
    useEffect(() => {
        ...
        getRtcToken(name, channel, 'host')
            .then(token => {
                ...
                rtcClient.join(process.env.NEXT_PUBLIC_AGORA_APP_ID as string, channel, token, name)
